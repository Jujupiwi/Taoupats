...
(function (d, v, q) {
    ...
    var B = function (a, b) {
        ...
        c.defs = {slide: 0, total: 0, image: "", images: [], width: c.sliderContent.width(),
        ...
        if (1 < c.defs.total && "bar" != c.defs.timer) {
            ...
            c.R = k / 2;
            var n = {stroke: b.timerBg, "stroke-width": h + 2 * g}, D = {stroke: b.timerColor, "stroke-width": h, "stroke-linecap": "round"}, m = {fill: b.timerColor, stroke: "none", "stroke-width": 0},
        ...
        "bar" == c.defs.timer ? (c.iviewTimer.css({opacity: b.timerOpacity, width: k, height: h, border: b.timerBarStroke + "px " + b.timerBarStrokeColor + " " + b.timerBarStrokeStyle, padding: g, background: b.timerBg}), c.barTimer.css({width: 0, height: h,
            background: b.timerColor, "float": "left"})) : c.iviewTimer.css({opacity: b.timerOpacity, width: i, height: j});
        c.setTimerPosition();
        ...
        d(".iview-video-close", c.slider).click(function () {
            ...
            a.animate({top: "-" + c.defs.height +
                "px"}, 1E3, "easeOutBounce", function () {
                a.hide();
                c.sliderContent.trigger("iView:play")
            })
        })
    };
    B.prototype = {timer: null, startSlider: function () {
        ...
        setCaption: function () {
            ...
            d(".iview-caption", b).each(function () {
                ...
                setTimeout(function () {
                    b.animate({opacity: a.options.captionOpacity, top: i, left: h, width: j, height: l}, g, k, function () {
                    })
                }, c);
                setTimeout(function () {
                    m.animate({opacity: a.options.captionOpacity,
                        top: 0, left: 0}, g, k)
                }, c + 100);
                c += 250
            })
            ...
            switch (a) {
                ...
                case "strip-up-left":
                    ...
                    e.each(function () {
                        ...
                        setTimeout(function () {
                            a.animate({height: "100%", opacity: "1.0"}, b.options.animationSpeed, b.defs.easing, function () {
                ...
                case "strip-left-right-down":
                    ...
                    e.each(function () {
                        ...
                        setTimeout(function () {
                            a.animate({width: "100%", opacity: "1.0"}, b.options.animationSpeed, b.defs.easing, function () {
                ...
                case "strip-up-down-left":
                    ...
                    e.each(function () {
                        var a = d(this);
                        0 == f ? (a.css({bottom: "",
                            top: "0px"}), f++) : (a.css({top: "", bottom: "0px"}), f = 0);
                        setTimeout(function () {
                            a.animate({height: "100%", opacity: "1.0"}, b.options.animationSpeed, b.defs.easing, function () {
                                g == b.options.strips - 1 && b.transitionEnd(b);
                                g++
                ...
                case "bottom-curtain":
                    ...
                    e.each(function () {
                        ...
                        setTimeout(function () {
                            "left-curtain" == a || "right-curtain" == a ? e.animate({width: g, opacity: "1.0"}, b.options.animationSpeed, b.defs.easing, function () {
                                f == b.options.strips - 1 && b.transitionEnd(b);
                                f++
                            }) : e.animate({height: h, opacity: "1.0"}, b.options.animationSpeed, b.defs.easing, function () {
                                f == b.options.strips - 1 && b.transitionEnd(b);
                                f++
                            })
                        }, 100 + c);
                ...
                case "zigzag-drop-bottom":
                    ...
                    e.each(function (e) {
                        ...
                        setTimeout(function () {
                            "zigzag-grow-top" == a || "zigzag-grow-bottom" == a ? f.animate({opacity: "1", height: g, width: j}, b.options.animationSpeed, b.defs.easing, function () {
                                e == h - 1 && b.transitionEnd(b)
                            }) : "zigzag-drop-top" == a || "zigzag-drop-bottom" == a ? f.animate({top: k, opacity: "1"}, b.options.animationSpeed, b.defs.easing, function () {
                                e == h - 1 && b.transitionEnd(b)
                    ...
                    for (n = 0; n < 2 * b.options.blockCols; n++) {
                        for (var p = n, j = 0; j < b.options.blockRows; j++)0 <= p && p < b.options.blockCols &&
                            function () {
                                ...
                                setTimeout(function () {
                                    e.animate({opacity: "1", width: g, height: k}, b.options.animationSpeed / 1.3, b.defs.easing, function () {
                ...
                case "block-drop-random":
                    ...
                    e.each(function (e) {
                        ...
                        setTimeout(function () {
                            f.animate({top: i, opacity: "1", height: g, width: k}, b.options.animationSpeed, b.defs.easing, function () {
                                e == h - 1 && b.transitionEnd(b)
                            })
                        }, 100 + c);
                        c += 20
                    ...
                    break;
                default:
                    opts = {strips: 1}, b.addStrips(!1, opts), e = d(".iview-strip:first", b.slider), e.css({height: "100%", width: b.defs.width}), "slide-in-right" == a ? e.css({height: "100%", width: b.defs.width, left: b.defs.width +
                        "px", right: ""}) : "slide-in-left" == a && e.css({left: "-" + b.defs.width + "px"}), e.animate({left: "0px", opacity: 1}, 2 * b.options.animationSpeed, b.defs.easing, function () {
                        b.transitionEnd(b)
                    })
            }
        }, shuffle: function (a) {
    ...
    r.prototype = {Preload: function (a) {
        var b = new Image;
    ...
    d.fn.iView = function (a) {
        a = jQuery.extend({fx: "random", easing: "easeOutQuad", strips: 20, blockCols: 10, blockRows: 5, animationSpeed: 500, pauseTime: 5E3, startSlide: 0, directionNav: !0, directionNavHoverOpacity: 0.6, controlNav: !1, controlNavNextPrev: !0,
            ...
            timerX: 10, timerY: 10, tooltipX: 5, tooltipY: -5, onBeforeChange: function () {
    ...
    p[A] = 250;
    p.throttleWindow = !0;
    d.event.special[w] = {setup: function () {
    ...
    d.event.special.swipe = {scrollSupressionThreshold: 10, durationThreshold: 1E3, horizontalDistanceThreshold: 30, verticalDistanceThreshold: 75, setup: function () {
        var a = d(this);
        a.bind(E, function (b) {
            function c(a) {
                if (e) {
            ...
            var f = b.originalEvent.touches ?
                b.originalEvent.touches[0] : b, e = {time: (new Date).getTime(), coords: [f.pageX, f.pageY], origin: d(b.target)}, g;
    ...
    d.each({swipeleft: "swipe",
        swiperight: "swipe"}, function (a, b) {
