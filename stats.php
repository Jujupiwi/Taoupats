                ...
                <ul class="nav">
                    ...
                    <li class="dropdown"><a href="#" class="dropdown-toggle"
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a href="#"><i class="icon-dribbble">&nbsp;</i>Stats</a></li>
...
<tr>
    ...
    <td style="text-align: center"><?php $match_1 = 19;
        echo $match_1; ?></td>
...
<tr>
    ...
    <td style="text-align: center"><?php $match_1 = 18;
        echo $match_1; ?></td>
    <td style="text-align: center"><i class="icon-star"></i> 3</td>
    <td style="text-align: center"><?php $but_1 = 4;
        echo $but_1; ?></td>
    <td style="text-align: center"> <?php if ($match_1 == 0) {
            echo $match_1;
        } else {
    ...
    <td style="text-align: center"><i class="icon-star"></i><?php $passe_1 = 5;
        echo $passe_1; ?></td>
    <td style="text-align: center"><?php if ($match_1 == 0) {
            echo $match_1;
        } else {
...
<tr>
    ...
    <td style="text-align: center"><?php $match_1 = 17;
        echo $match_1; ?></td>
    <td style="text-align: center">0</td>
...
<tr>
    ...
    <td style="text-align: center"><?php $match_1 = 16;
        echo $match_1; ?></td>
    <td style="text-align: center">1</td>
    <td style="text-align: center"><?php $but_1 = 0;
        echo $but_1; ?></td>
...
<tr>
    ...
    <td style="text-align: center"><?php $match_1 = 15;
        echo $match_1; ?></td>
    <td style="text-align: center">1</td>
    <td style="text-align: center"><?php $but_1 = 2;
        echo $but_1; ?></td>
    ...
    <td style="text-align: center"><?php $passe_1 = 4;
        echo $passe_1; ?></td>
    <td style="text-align: center"><?php if ($match_1 == 0) {
            echo $match_1;
        } else {
...
<tr>
    ...
    <td style="text-align: center"><?php $match_1 = 15;
        echo $match_1; ?></td>
    <td style="text-align: center">0</td>
    <td style="text-align: center"><?php $but_1 = 5;
        echo $but_1; ?></td>
    <td style="text-align: center"><?php if ($match_1 == 0) {
            echo $match_1;
        } else {
    ...
    <td style="text-align: center"><?php $passe_1 = 5;
        echo $passe_1; ?></td>
...
<tr>
    ...
    <td style="text-align: center"><?php $match_1 = 14;
        echo $match_1; ?></td>
    <td style="text-align: center">1</td>
    <td style="text-align: center"><?php $but_1 = 5;
        echo $but_1; ?></td>
...
<tr>
    ...
    <td style="text-align: center"><?php $match_1 = 13;
        echo $match_1; ?></td>
    <td style="text-align: center">1</td>
    <td style="text-align: center"><?php $but_1 = 1;
        echo $but_1; ?></td>
...
<tr>
    ...
    <td style="text-align: center"><?php $match_1 = 12;
        echo $match_1; ?></td>
...
<tr>
    ...
    <td style="text-align: center"><?php $match_1 = 11;
        echo $match_1; ?></td>
    <td style="text-align: center">1</td>
    <td style="text-align: center"><?php $but_1 = 1;
        echo $but_1; ?></td>
...
<tr>
    ...
    <td style="text-align: center"><?php $match_1 = 10;
        echo $match_1; ?></td>
    <td style="text-align: center">1</td>
    <td style="text-align: center"><?php $but_1 = 0;
        echo $but_1; ?></td>
...
<tr class="success">
    ...
    <td style="text-align: center"><?php $match_1 = 8;
        echo $match_1; ?></td>
    <td style="text-align: center">1</td>
    <td style="text-align: center"><i class="icon-star"></i><?php $but_1 = 10;
        echo $but_1; ?></td>
    <td style="text-align: center"><i class="icon-star"></i><?php if ($match_1 == 0) {
            echo number_format($match_1, 2);
        } else {
...
<tr>
    ...
    <td style="text-align: center"><?php $match_1 = 3;
        echo $match_1; ?></td>
    <td style="text-align: center">0</td>
    <td style="text-align: center"><?php $but_1 = 0;
        echo $but_1; ?></td>
...
<tr>
    <td style="text-align: center">ThomasP</td>
    <td style="text-align: center"><?php $match_1 = 1;
        echo $match_1; ?></td>
    <td style="text-align: center">0</td>
    <td style="text-align: center"><?php $but_1 = 0;
...
<table
    ...
    <tr>
        ...
        <td style="color: #5DAF6B; text-align: center;">7</td>
        <td style="color: #4664C6; text-align: center;">3</td>
        <td style="color: #C64646; text-align: center;">10</td>
    </tr>
</table>
</div>
</div>
