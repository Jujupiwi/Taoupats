...
<div class="form">
    ...
    <?php else: ?>
        <!-- language choice -->
        <br/><h1>Welcome to the CrawlProtect installation</h1><h2>First you have to choose the language to use:</h2>
        <br/>
        ...
        <div class="form">
            <form action="index.php" method="POST">
                <h1>
                    <table width="750px">
                        <tr>
                            <td align="left"><input type="radio" name="lang" value="english"/>&nbsp;<img border="0"
                                                                                                         src="./images/flags/gb.gif"
                                                                                                         alt="english"
                                                                                                         width="18px"
                                                                                                         height="12px">&nbsp;English
                            </td>
                            <td align="left"><input type="radio" name="lang" value="italian"/>&nbsp;<img border="0"
                                                                                                         src="./images/flags/it.gif"
                                                                                                         alt="italian"
                                                                                                         width="18px"
                                                                                                         height="12px">&nbsp;Italiano
                            </td>
                            <td align="left"><input type="radio" name="lang" value="french"/>&nbsp;<img border="0"
                                                                                                        src="./images/flags/fr.gif"
                                                                                                        alt="french"
                                                                                                        width="18px"
                                                                                                        height="12px">&nbsp;Français
                            </td>
                            <td align="left"><input type="radio" name="lang" value="russian"/>&nbsp;<img border="0"
                                                                                                         src="./images/flags/ru.gif"
                                                                                                         alt="russian"
                                                                                                         width="18px"
                                                                                                         height="12px">&nbsp;Pусский
                            </td>
                        ...
                        <tr>
                            <td align="left"><input type="radio" name="lang" value="swedish"/>&nbsp;<img border="0"
                                                                                                         src="./images/flags/se.gif"
                                                                                                         alt="swedish"
                                                                                                         width="18px"
                                                                                                         height="12px">&nbsp;Svenska
                            </td>
                            <td align="left"><input type="radio" name="lang" value="spanish"/>&nbsp;<img border="0"
                                                                                                         src="./images/flags/es.gif"
                                                                                                         alt="spanish"
                                                                                                         width="18px"
                                                                                                         height="12px">&nbsp;Español
                            </td>
