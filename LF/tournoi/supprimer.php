...
<div class="breadcrumbs margin-bottom-40">
    <div class="container">
        <h1 class="pull-left">Supprimer Tournoi</h1>
...
<div class="container" style="margin-bottom: 180px;">
    <div class="row">
        <div class="col-md-6 col-md-offset-3">
            <form class="reg-page" method="post" id="suppr" style="text-align: center" action="suppr.php">
                <div class="reg-header">
                    <h3>Supprimer Tournoi</h3>
                </div>
                <div class="row">
                    <div class="col-lg-offset-2 col-lg-8">
                        <label for="name">Nom du Tournoi : <span style="color:red;">*</span></label>
                        <select class="form-control" id="name" name="name">
                            <?php
                            $sql = $mysqli->query("select nom_tournoi from tournoi where login = '$login';");
                ...
                <center>
                    <div class="row">
                        <div class="col-lg-offset-4 col-lg-4">
                            <input class="btn-u btn-u-blue" id="guillaume" type="submit" value="Continuer">
                        </div>
                    </div>
                </center>
            </form>
