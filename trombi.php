                ...
                <ul class="nav">
                    ...
                    <li class="dropdown"><a href="#" class="dropdown-toggle"
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a href="match.php"><i class="icon-info-sign">&nbsp;</i>Dernier Match</a>
                            </li>
                        </ul>
                    </li>
                    <li class="dropdown"><a href="#" class="dropdown-toggle"
                    ...
                    <li><a href="#"><i class="icon-user">&nbsp;&nbsp;</i>Trombi</a>
                    </li>
                    <li class="visible-desktop"><a href="sondage.php"><i
                                class="icon-signal">&nbsp;</i>Sondages</a>
                    </li>
...
<div class="row-fluid">
    <div class="span12">
        <blockquote>
            <h6><i class="icon-user icon-white"> </i> Defenseurs</h6>
        </blockquote>
    </div>
</div>
<br>
    ...
    <div class="span12">
        <ul class="thumbnails">
            ...
            <li class="span3">
                <div class="thumbnail">
                    <img alt="120x180" data-src="bootstrap/js/bootstrap.js/120x180"
                         style="width: 105px; height: 180px;" src="images/team/JB.jpg">
...
<div class="row-fluid">
    <div class="span12">
        <blockquote>
            <h6><i class="icon-user icon-white"></i>Milieux</h6>
        </blockquote>
    </div>
</div>
<br>
...
<div class="row-fluid">
    <div class="span12">
        <blockquote>
            <h6><i class="icon-user icon-white"> </i> Attaquants</h6>
        </blockquote>
    </div>
</div>
<br>
...
<div class="row-fluid">
    <div class="span12">
        <blockquote>
            <h6><i class="icon-user icon-white"> </i> Coachs</h6>
        </blockquote>
    </div>
</div>
<br>
...
<div class="row-fluid">
    <div class="span12">
        <blockquote>
            <h6><i class="icon-user icon-white"> </i>Dirigeants</h6>
        </blockquote>
    </div>
</div>
<br>
    ...
    <div class="span12">
        <ul class="thumbnails">
            ...
            <li class="span2">
                <div class="thumbnail">
                    <img alt="120x180" data-src="bootstrap/js/bootstrap.js/120x180"
                         style="width: 120px; height: 180px;" src="images/team/x1.jpg">
            ...
            <li class="span2">
                <div class="thumbnail">
                    <img alt="120x180" data-src="bootstrap/js/bootstrap.js/120x180"
                         style="width: 120px; height: 180px;" src="images/team/x3.jpg">
            ...
            <li class="span2">
                <div class="thumbnail">
                    <img alt="120x180" data-src="bootstrap/js/bootstrap.js/120x180"
                         style="width: 120px; height: 180px;" src="images/team/x2.jpg">
    ...
    <div class="span12">
        <ul class="thumbnails">
            <li class="span2">
                <div class="thumbnail">
                    <img alt="120x180" data-src="bootstrap/js/bootstrap.js/120x180"
                         style="width: 120px; height: 180px;" src="images/team/x4.jpg">
            ...
            <li class="span2">
                <div class="thumbnail">
                    <img alt="120x180" data-src="bootstrap/js/bootstrap.js/120x180"
                         style="width: 120px; height: 180px;" src="images/team/x5.jpg">
