...
<div class="breadcrumbs margin-bottom-40">
    <div class="container">
        <h1 class="pull-left">Forfait Tournoi</h1>
...
<div class="container" style="margin-bottom: 180px;">
    <div class="row">
        <div class="col-md-6 col-md-offset-3">
            <form class="reg-page" method="post" style="text-align: center" action="forfaitrequete.php">
                <div class="reg-header">
                    <h3>Forfait Tournoi</h3>
                </div>
                <div class="row">
                    <div class="col-lg-offset-2 col-lg-8">
                        <label for="name">Nom du joueur forfait : <span style="color:red;">*</span></label>
                        <select class="form-control" name="joueur" id="name">
                            <?php
                            $sql = $mysqli->query("select joueur from joueur where login = '$login' and nom_tournoi='$name';");
                ...
                <center>
                    <div class="row">
                        <div class="col-lg-offset-4 col-lg-4">
                            ...
                            <input type="submit" class="btn-u btn-u-blue" value="Valider Forfait">
                        </div>
                    </div>
                </center>
            </form>
    ...
    <div class="row">
        <div class="col-lg-offset-3 col-lg-4">
            <a class="btn-u btn-u-red" href="tableau.php?name=<?php echo $name; ?>" width="100px" height="30px">&nbsp;&nbsp;Retour&nbsp;&nbsp;</a>
        </div>
    </div>
</div>
<!--/container-->
