    ...
    <div class="row-fluid">
        <div class="span12">
            ...
            <table
                ...
                <?php include 'contenu/archive_calendrier_contenu.php'; ?>
            </table>
            <table
                class="table table-bordered table-striped table-condensed table-hover">
                <thead>
                <tr>
                    <th width="20%" style="text-align: center;" rowspan="2">Bilan</th>
                    <th width="20%" style="text-align: center;">Nb Matchs Jou�s</th>
                    <th width="20%" style="color: #5DAF6B; text-align: center;">Victoires</th>
                    <th width="20%" style="color: #4664C6; text-align: center;">Nuls</th>
                    <th width="20%" style="color: #C64646; text-align: center;">D�faites</th>
                </tr>
                </thead>
                <tbody>
                <tr>
                    ...
                    <td style="color: #5DAF6B; text-align: center;">17</td>
                    <td style="color: #4664C6; text-align: center;">4</td>
                    <td style="color: #C64646; text-align: center;">14</td>
                </tr>
                </tbody>
            </table>
        </div>
