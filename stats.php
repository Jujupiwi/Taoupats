...
<tr>
    ...
    <td style="text-align: center"><i class="icon-star"></i><?php $passe_1 = 4;
        echo $passe_1; ?></td>
...
<tr class="success">
    ...
    <td style="text-align: center"><?php $match_1 = 2;
        echo $match_1; ?></td>
    <td style="text-align: center">0</td>
    <td style="text-align: center"><i class="icon-star"></i><?php $but_1 = 5;
        echo $but_1; ?></td>
    <td style="text-align: center"><i class="icon-star"></i><?php if ($match_1 == 0) {
            echo number_format($match_1, 2);
        } else {
...
<table
    ...
    <tr>
        ...
        <td style="color: #5DAF6B; text-align: center;">4</td>
